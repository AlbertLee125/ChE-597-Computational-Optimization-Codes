...
# Parameters
model.demand = pyo.Param(model.T, initialize={1: 3500, 2: 500, 3: 100, 4: 850}, mutable=True, doc='Demand for each quarter') # Changed the Parameters for first quarter to make it infeasible
