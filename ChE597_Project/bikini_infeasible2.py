...
model.capacity = pyo.Param(model.T, initialize={1: 1200, 2: 600, 3: 1200, 4: 1200}, mutable=True, doc='Production capacity for each quarter') # Infeasible on the capacity.
